...
-----------------------------------------------------------------------------*/
    ...
    OPTENT3(0, "headerdump", OPT_FLAG,   NULL, &cmdline_p->headerdump,   0);
    OPTENT3(0, "debug",      OPT_FLAG,   NULL, &cmdline_p->headerdump,   0);
    OPTENT3(0, "alphaout",   OPT_STRING, &cmdline_p->alpha_filename,
            &alpha_spec, 0);
    ...
    if (argc - 1 == 0)
        cmdline_p->input_filename = "=";  /* he wants stdin */
    else if (argc - 1 == 1)
