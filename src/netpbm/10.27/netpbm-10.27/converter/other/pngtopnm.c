...
static float displaygamma; /* display gamma */
...
convertpng (FILE *             const ifp, 
  ...
  *errorlevelP = 0;
  ...
  getBackgroundColor(info_ptr, cmdline.background, totalgamma, &bgColor);
